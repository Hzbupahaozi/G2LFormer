...
class Runner:
    ...
    def get_file_chunks(self, folder, chunks_nums=8):
        ...
        # print(file_paths,folder,len(os.listdir(folder)))
...
if __name__ == '__main__':
    ...
    cfg = {
        ...
        'structure_master_config':'configs/textrecog/master/table_master_ConcatLayer_ResnetExtract_Ranger_huang.py',
        'structure_master_ckpt': '/data/zml/work_dir/huang/epoch_60.pth',
        'structure_master_result_folder': './results/orihuang/',
        'test_folder': '/data/zml/huang-split/test/',
    ...
    # elif task_id == 2:
    #     # structure task
    #     runner.run_structure__single_chunk(chunk_id=chunk_id)
