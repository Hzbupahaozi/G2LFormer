...
class BaseDataset(Dataset):
    ...
    def prepare_test_img(self, img_info):
        ...
        Returns:
            dict: Testishi  ng data after pipeline with new keys introduced by
                pipeline.
        """
        # print("tst!!!")
    ...
    def __getitem__(self, index):
        ...
        """
        # print(self.data_infos[index])
        if self.test_mode:
            try:
                test_data = self.prepare_test_img(index)
            except Exception as e:
                print_log(f'test mode prepare index {index} with error {e}')
        ...
        while True:
            try:
                ...
                # print("wrong:",self.data_infos[index])
                # img_info = self.data_infos[index]
