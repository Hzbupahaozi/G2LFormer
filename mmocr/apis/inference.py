...
def model_inference(model, imgs, texts, batch_mode=False,img_name = None):
    ...
    for img in imgs:
        ...
        d = data["img_metas"]
        text = d._data["text"]
        # results[key] = DC(results[key], **field).img_norm_cfg()#
        # print(text)
        bbox_masks = build_bbox_mask(text)
        d._data["bbox_masks"] = bbox_masks
        # print("d1:",data)
    ...
    data['img_metas'][0][0]["filename"] = img_name# 1215
