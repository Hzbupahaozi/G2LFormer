...
class RandomRotateImageBox:
    ...
    def __init__(self, min_angle=-30, max_angle=30, box_type='char_quads'):
    ...
    def __call__(self, results):
        ...
        # print("ann_info:",results['ann_info'])
        # in_boxes = results['ann_info'][self.box_type]
        # print("in_boxes????:",in_boxes )
        print("no",in_img.size())
        img_width, img_height = 480,480#in_img.size()
