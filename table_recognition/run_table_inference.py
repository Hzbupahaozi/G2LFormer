...
if __name__ == "__main__":
    ...
    # structure
    # subprocess.call("CUDA_VISIBLE_DEVICES=0 python -u ./table_recognition/table_inference_hwl.py 4 0 2 &"
    #                 "CUDA_VISIBLE_DEVICES=1 python -u ./table_recognition/table_inference_hwl.py 4 1 2 &"
    #                 "CUDA_VISIBLE_DEVICES=2 python -u ./table_recognition/table_inference_hwl.py 4 2 2 &"
    #                 "CUDA_VISIBLE_DEVICES=3 python -u ./table_recognition/table_inference_hwl.py 4 3 2 &", shell=True)
    subprocess.call("CUDA_VISIBLE_DEVICES=1 python -u ./table_recognition/table_inference_chs_honor_wuxian.py", shell=True)
    # time.sleep(60)
